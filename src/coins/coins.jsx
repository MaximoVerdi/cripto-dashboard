  ...
  return (
    <div className="coins-section"> 
        <div  className="coin bitcoin" data-aos="fade-up">
            ...
            <p className="changePrice">{cryptoData?.BTC?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%</p>
        ...
        <div className="coin ordi" data-aos="fade-up">
            ...
            <p className="changePrice">{cryptoData?.ORDI?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%</p>
        ...
        <div className="coin algo" data-aos="fade-up">
            ...
            <p className="changePrice">{cryptoData?.ALGO?.USDT?.CHANGEPCT24HOUR.toLocaleString()}% </p>
        ...
        <div className="coin theta" data-aos="fade-up">
           ...
           <p className="changePrice">{cryptoData?.THETA?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%</p>
        ...
        <div className="coin hbar" data-aos="fade-up">
            ...
            <p className="changePrice">{cryptoData?.HBAR?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%</p>
        ...
        <div className="coin sui" data-aos="fade-up">
            ...
            <p className="changePrice">{cryptoData?.SUI?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%</p>
