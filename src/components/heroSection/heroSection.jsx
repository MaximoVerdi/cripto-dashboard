      ...
      <div className="hero-section__info">
        ...
        <ul>
          <li>
            ...
            <p>
              Live Prices & Market Insights{" "}
              <strong>whit real-time updates </strong>
            </p>
          </li>
          <li>
            <i class="bx bxs-check-circle"></i>
            <p>
              Advanced <strong>Portfolio Managment</strong> to track your
              holdings{" "}
            </p>
          </li>
          <li>
            <i class="bx bxs-check-circle"></i>
            <p>
              Secure & Reliable Data powered by <strong>top-tier </strong>APIs
            </p>
          </li>
        </ul>
