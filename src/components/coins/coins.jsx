  ...
  return (
    <div className="coins-section">
      ...
      <div className="coin bitcoin" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.BTC?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.BTC?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.BTC?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
      ...
      <div className="coin ordi" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.ORDI?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.ORDI?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.ORDI?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
          href="https://es.tradingview.com/symbols/ORDIUSDT/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ver mas
      ...
      <div className="coin algo" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.ALGO?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.ALGO?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.ALGO?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
          href="https://es.tradingview.com/symbols/ALGOUSDT/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ver mas
      ...
      <div className="coin theta" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.THETA?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.THETA?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.THETA?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
          href="https://es.tradingview.com/symbols/THETAUSDT/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ver mas
      ...
      <div className="coin hbar" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.HBAR?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.HBAR?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.HBAR?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
          href="https://es.tradingview.com/symbols/HBARUSDT/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ver mas
      ...
      <div className="coin sui" data-aos="fade-up">
        ...
        <p
          className={`changePrice ${cryptoData?.SUI?.USDT?.CHANGEPCT24HOUR < 0 ? "negative" : ""}`}
        >
          {cryptoData?.SUI?.USDT?.CHANGEPCT24HOUR.toLocaleString()}%
        </p>
        <p className="volume">
          {" "}
          ${cryptoData?.SUI?.USDT?.VOLUMEDAY.toLocaleString()}
        </p>
        <a
          href="https://es.tradingview.com/symbols/SUIUSDT/"
          target="_blank"
          rel="noopener noreferrer"
        >
          Ver mas
